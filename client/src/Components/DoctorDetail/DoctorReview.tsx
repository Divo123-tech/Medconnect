...
import { CheckCircle2, Pen, Star, Trash2 } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center pb-2">
        <h4 className="text-lg font-medium text-teal-800">{review.title}</h4>
        ...
        {user?.id == review.patientId && (
          <div className="flex gap-2">
            ...
            <Button
              className="text-red-500 border-red-500 border cursor-pointer hover:bg-gray-100"
